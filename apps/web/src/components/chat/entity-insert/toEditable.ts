...
export function toEditableCharacter(
  raw: ExtractedCharacterItem,
  index: number
): EditableCharacter {
  return {
    ...raw,
...
export function toEditableSetting(
  raw: ExtractedSettingItem,
  index: number
): EditableSetting {
  return {
    ...raw,
...
export function toEditablePlot(
  raw: ExtractedChatPlotItem,
  index: number
): EditablePlot {
  return {
    ...raw,
