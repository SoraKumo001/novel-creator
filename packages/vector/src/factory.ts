...
export function createVectorStore(env: Env, options: CreateVectorStoreOptions = {}): VectorStore {
  switch (env.VECTOR_STORE_PROVIDER) {
    ...
    default:
      throw new Error(`未対応の VECTOR_STORE_PROVIDER: ${env.VECTOR_STORE_PROVIDER}`);
  }
}
